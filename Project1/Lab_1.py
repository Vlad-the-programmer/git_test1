...
[ True,True,LogCon.NOT(True),LogCon.AND(True, True),LogCon.OR(True, True), LogCon.IMP0(True, True),
 LogCon.EQV(True, True),LogCon.XOR(True, True)],
[ True,False,LogCon.NOT(False),LogCon.AND(True, False),LogCon.OR(True, False), LogCon.IMP0(True, False),
 LogCon.EQV(True, False),LogCon.XOR(True, False)],
[False,True, LogCon.NOT(True), LogCon.AND(False, True) ,LogCon.OR(False, True), LogCon.IMP0(False, True),
 LogCon.EQV(False, True),LogCon.XOR(False, True)],
[False, False,LogCon.NOT(False),LogCon.AND(False, False),LogCon.OR(False, False), LogCon.IMP0(False, False),
 LogCon.EQV(False, False),LogCon.XOR(False, False)], 
